...
invoice1 = Invoice(Customer('Customer', 'Basic', '5121234567'), '03012018')
...
invoice2 = Invoice(AverageCustomer('Customer', 'Average', '5121234567'), '03012018')
invoice3 = Invoice(GoodCustomer('Customer', 'Good', '5121234567'), '03012018')
